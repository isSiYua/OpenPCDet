...
class BaseBEVBackbone(nn.Module):
    def __init__(self, model_cfg, input_channels):
        ...
        # ✨ NEW: 实例化 CBAM，输入通道数为融合后的特征数 (通常是 384)
        # self.cbam = CBAMBlock(in_planes=self.num_bev_features, kernel_size=3) 
...
#         # 用 Conv2d 替代 Linear，完全适配 2D 张量
#         self.fc1 = nn.Conv2d(in_planes, in_planes // ratio, 1, bias=False)
#         self.act = nn.SiLU()  # 保持激活函数一致性，使用 SiLU
